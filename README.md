...
- **Prompt Templates**: Pre-built templates for common use cases (product photos, hero images, etc.)
...
4. Choose a template or write your own prompt
5. Select aspect ratio
6. Click "Generate"
7. Preview and click "Use This Image"
